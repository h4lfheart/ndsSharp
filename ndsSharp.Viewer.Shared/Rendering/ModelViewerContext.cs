...
public class ModelViewerContext : GameWindow
{
    ...
    public ModelViewerContext(bool useGrid = true) : base(GameWindowSettings.Default, Settings)
    {
        Renderer = new RenderManager(useGrid);
        ...
        {
            Camera.Speed += args.OffsetY;
            Camera.Speed = Math.Clamp(Camera.Speed, 0.01f, 500.0f);
        };
